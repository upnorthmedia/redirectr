...
The plugin begins monitoring for broken links automatically upon activation. No additional configuration required.
...
1. Redirect management - View, search, and manage all your redirects
2. Broken link monitor - See which URLs are generating 404 errors
3. One-click redirect creation - Convert broken links to redirects instantly
4. Settings page - Configure logging and retention options
...
= 1.0.0 =
Initial release of Redirectr. Install to start managing redirects and monitoring broken links.
